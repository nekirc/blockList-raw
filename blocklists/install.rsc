...
add name="dl-dshield-recommended" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/dshield-recommended.rsc" mode=https dst-path=dshield-recommended.rsc
...
add name="dl-blocklist-de" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/blocklist-de.rsc" mode=https dst-path=blocklist-de.rsc
...
add name="dl-firehol-abusers-1d" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/firehol-abusers-1d.rsc" mode=https dst-path=firehol-abusers-1d.rsc
...
add name="dl-spamhaus-drop" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/spamhaus-drop.rsc" mode=https dst-path=spamhaus-drop.rsc
...
add name="dl-feodo-recommended" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/feodo-recommended.rsc" mode=https dst-path=feodo-recommended.rsc
...
add name="dl-firehol-level1" source={
    /tool fetch url="https://github.com/nekirc/blockList-raw/main/blockList-raw/blocklists/firehol-level1.rsc" mode=https dst-path=firehol-level1.rsc
...
add interval=1d name="install-dshield-recommended-scheduled" start-time=00:10:00 on-event=replace-dshield-recommended
add interval=1d name="dl-blocklist-de-scheduled" start-time=00:15:00 on-event=dl-blocklist-de
add interval=1d name="install-blocklist-de-scheduled" start-time=00:20:00 on-event=replace-blocklist-de
add interval=1d name="dl-firehol-abusers-1d-scheduled" start-time=00:25:00 on-event=dl-firehol-abusers-1d
add interval=1d name="install-firehol-abusers-1d-scheduled" start-time=00:30:00 on-event=replace-firehol-abusers-1d
add interval=1d name="dl-spamhaus-drop-scheduled" start-time=00:35:00 on-event=dl-spamhaus-drop
add interval=1d name="install-spamhaus-drop-scheduled" start-time=00:40:00 on-event=replace-spamhaus-drop
add interval=1d name="dl-feodo-recommended-scheduled" start-time=00:45:00 on-event=dl-feodo-recommended
